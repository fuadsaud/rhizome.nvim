...
local _2amodule_name_2a = "rhizome.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("rhizome.aniseed.core"), autoload("rhizome.aniseed.compile"), autoload("rhizome.aniseed.fennel"), autoload("rhizome.aniseed.fs"), autoload("rhizome.aniseed.nvim")
