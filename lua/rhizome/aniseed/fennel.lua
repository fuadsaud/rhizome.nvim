...
local _2amodule_name_2a = "rhizome.aniseed.fennel"
local _2amodule_2a
do
...
local autoload = (require("rhizome.aniseed.autoload")).autoload
local a, fs, nvim, str = autoload("rhizome.aniseed.core"), autoload("rhizome.aniseed.fs"), autoload("rhizome.aniseed.nvim"), autoload("rhizome.aniseed.string")
...
local function impl()
  local compiler = require("rhizome.aniseed.deps.fennel")
