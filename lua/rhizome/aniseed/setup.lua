...
local _2amodule_name_2a = "rhizome.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("rhizome.aniseed.core"), autoload("rhizome.aniseed.env"), autoload("rhizome.aniseed.eval"), autoload("rhizome.aniseed.nvim")
