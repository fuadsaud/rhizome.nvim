...
local _2amodule_name_2a = "rhizome.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("rhizome.aniseed.compile"), autoload("rhizome.aniseed.fennel"), autoload("rhizome.aniseed.fs"), autoload("rhizome.aniseed.nvim")
