...
defn(known_roots, {}, (_2aconfig_2a).roots)
...
local function find_in_known_roots(known_roots, input_path)
  ...
  return a.first(a.filter(_2_, known_roots))
end
local function derive_root_2a(known_roots, input_path)
...
defn(label_for_root, {root}, (root.label or default_label(root)))
local function label_2a(input_path)
  return label_for_root(derive_root(input_path))
end
defn(label_for_tabnr, {tabnr}, label_2a(vim.fn.getcwd(-1, tabnr)))
defn(open_in_current_tab, {input_path}, open_root("edit", derive_root(input_path)))
defn(open_in_new_tab, {input_path}, open_root("tabedit", derive_root(input_path)))
defn(setup, {opts}, a["merge!"](_2aconfig_2a, opts))
